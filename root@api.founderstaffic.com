...
# Taken from https://github.com/jacobobryant/biff/blob/master/example/server-setup.sh
# Thank you Jacob O'Bryant!
# Prepare a digital ocean droplet for running a Clojure app.
